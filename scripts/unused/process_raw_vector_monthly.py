...
sys.path.insert(0, "/cluster/home/heig/NorESM/Process/EC/Leo/libvector") # CHA: update path
...
casename = 'N1850frc2_SMB1' # CHA: update to SSP if needed

#datadir  = os.path.join('/glade/work/lvank/CESM2', casename ) # CHA: update path
datadir  = os.path.join('/cluster/work/users/heig/archive', casename , 'lnd/hist') # CHA: update path
outdir   = os.path.join(datadir, 'vector2gridded3d') 

if not os.path.exists(outdir):
   os.makedirs(outdir)

stream_tag  = 'h2' # output stream identifier. Vector data is typically 'h1'.

print(casename)

varlist = []
varlist += 'SNOW QSNOFRZ QSNOMELT QICE_MELT QSOIL '.split()

# N1850frc2_SMB1.clm2.h2.0001-01.nc
...
slices = '01', '02' , '03' , '04' , '05' , '06' , '07' , '08' , '09' , '10' , '11' , '12' 
...
for slic in slices:
   ...
   for varname in varlist:
      ...
      fname_vector = os.path.join(datadir, 'vector1',  casename + ".clm2." + stream_tag + "." + varname + "." + slic + ".nc")
      print(fname_vector)
